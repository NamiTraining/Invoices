			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">{{Auth::user()->name ??'None'}}</h4>
							<span class="mb-0 text-muted">{{Auth::user()->email ??'None'}}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='example') }}">قائمة الفواتير</a></li>
                            @endcan
                                @can('الفواتير المدفوعة')
                                    <li><a class="slide-item" href="{{ url('/' . $page='example_paid') }}">الفواتير المدفوعة</a></li>
                                @endcan
                    </li>

                        @can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='example_unpaid') }}">الفواتير غير المدفوعة</a></li>
                        @endcan
                        @can('الفواتير المدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='example_Partial') }}">الفواتير المدفوعة جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                ...
                @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='example_report') }}">تقارير الفواتير</a></li>
