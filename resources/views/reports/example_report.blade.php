        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="/Search_example" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="example_number">
                                <p class="mg-b-10">البحث برقم الفاتورة</p>
                                <input type="text" class="form-control" id="example_number" name="example_number">
